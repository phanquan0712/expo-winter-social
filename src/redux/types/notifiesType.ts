...
export const LOAD_NOTIFIES = 'LOAD_NOTIFIES';
...
export interface ILoadNotifiesType {
   type: typeof LOAD_NOTIFIES;
   payload: boolean;
}
...
export type INotifyType = ICreateNotifyType | IDeleteNotifyType | IGetNotifyType | any | IUpdateNotifyType | ILoadNotifiesType;